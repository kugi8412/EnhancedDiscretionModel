#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Universal multi-task training script for CNN, VQ-VAE, and Oracle-conditioned models."""
...
def train_model(config):
    ...
    # Weight decay column added to CSV headers
    headers = [
    ...
    for epoch in range(epochs):
        ...
        # Manual weight decay update
        if wd_sched_apply:
            if epoch < warmup_epochs:
                # Linear warmup for weight decay
        ...
        # Weight decay added to row data
        row_data = [
